...
| **[reporting.md](reporting.md)** | Templates, schedules and runs; windows and timezones; what a report over last March will contain; delivery, share links, the S3 mirror, and where the files live. |
